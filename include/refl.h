...
public:
    ...
    public:
        ...
        template<class R, class... P> ClassReflector &  HasMethod(std::string name, R (C::*method)(P...)               ) { lib.functions.push_back(lib.BindWithSignature(move(name), [method](               C & c, P... p) { return (c.*method)(std::forward<P>(p)...); }, Tag<R(               C &, P...)>())); return *this; }
        template<class R, class... P> ClassReflector &  HasMethod(std::string name, R (C::*method)(P...) const         ) { lib.functions.push_back(lib.BindWithSignature(move(name), [method](const          C & c, P... p) { return (c.*method)(std::forward<P>(p)...); }, Tag<R(const          C &, P...)>())); return *this; }
        template<class R, class... P> ClassReflector &  HasMethod(std::string name, R (C::*method)(P...)       volatile) { lib.functions.push_back(lib.BindWithSignature(move(name), [method](      volatile C & c, P... p) { return (c.*method)(std::forward<P>(p)...); }, Tag<R(      volatile C &, P...)>())); return *this; }
        template<class R, class... P> ClassReflector &  HasMethod(std::string name, R (C::*method)(P...) const volatile) { lib.functions.push_back(lib.BindWithSignature(move(name), [method](const volatile C & c, P... p) { return (c.*method)(std::forward<P>(p)...); }, Tag<R(const volatile C &, P...)>())); return *this; }
        template<         class... P> ClassReflector &  HasConstructor()                                                 { lib.functions.push_back(lib.BindWithSignature(type.className,                         [](P... p) { return           C(std::forward<P>(p)...); }, Tag<C(                    P...)>())); return *this; }
    };
    ...
    template<class R, class... P> void  BindFunction(std::string name, R (*func)(P...))     { functions.push_back(BindWithSignature(move(name), func, Tag<R(P...)>())); }
...
private: // IMPLEMENTATION DETAILS
    ...
    template<class F, class R, class... P> Function BindWithSignature(std::string name, F func, Tag<R   (P...)> tag) { return Function(move(name), DeduceType<R   (P...)>(), [func](void * args[]) { return std::make_shared<R>(CallWithArgs(func, args, tag)); }); }
    template<class F, class R, class... P> Function BindWithSignature(std::string name, F func, Tag<R & (P...)> tag) { return Function(move(name), DeduceType<R & (P...)>(), [func](void * args[]) { return std::shared_ptr<void>(&CallWithArgs(func, args, tag)); }); }
    template<class F, class R, class... P> Function BindWithSignature(std::string name, F func, Tag<R &&(P...)> tag) { return Function(move(name), DeduceType<R &&(P...)>(), [func](void * args[]) { return std::shared_ptr<void>(&CallWithArgs(func, args, tag)); }); }
    template<class F,          class... P> Function BindWithSignature(std::string name, F func, Tag<void(P...)> tag) { return Function(move(name), DeduceType<void(P...)>(), [func](void * args[]) { CallWithArgs(func, args, tag); return std::shared_ptr<void>(); }); }
